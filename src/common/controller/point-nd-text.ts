import { connectValues, createValue, NumberTextController, Parser, PointAxis, PointNdAssembly, Value, ValueController, ViewProps } from "@tweakpane/core";
...
export function createAxisController<PointNd>(
	doc: Document,
